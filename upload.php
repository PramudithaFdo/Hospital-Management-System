...
if(isset($_POST["submit"]) && !empty($_FILES["file"]["name"])){
    ...
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
            ...
            $insert = $con->query("INSERT into prescriptions (app_id, p_name, d_id, upload_path, create_datetime) VALUES ($app_no, '".$rows_select['p_name']."' , '".$rows_select['d_id']."' , '".$fileName."', NOW())");
